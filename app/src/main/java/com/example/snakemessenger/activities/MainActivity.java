...
import com.example.snakemessenger.adapters.RecentConversationsAdapter;
import com.example.snakemessenger.databinding.ActivityMainBinding;
...
public class MainActivity extends BaseActivity implements ConversionListener {
    ...
    private void init(){
        ...
        conversationsAdapter = new RecentConversationsAdapter(conversions, this);
        binding.conversionRcview.setAdapter(conversationsAdapter);
        firestore = FirebaseFirestore.getInstance();
    }

    private void setListeners(){
        binding.imgSignout.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private final EventListener<QuerySnapshot> eventListener = (value, error) -> {
        ...
        if (value != null){
            ...
            binding.conversionRcview.smoothScrollToPosition(0);
            binding.conversionRcview.setVisibility(View.VISIBLE);
    ...
    private void updateToken(String token){
        ...
        DocumentReference documentReference = firestore.collection(Constants.KEY_COLECTION_USERS)
